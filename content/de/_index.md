...
<a class="btn btn-lg btn-secondary me-3 mb-4" href="https://www.ripperdoc.de/kontakt/">
  Reparatur anfragen <i class="fas fa-tools ms-2"></i>
</a>
<p class="lead mt-5">Technische Artikel zur MacBook-, Notebook- und PC-Reparatur &mdash; offen und ohne Werbung.</p>
{{< blocks/link-down color="info" >}}
{{< /blocks/cover >}}


{{% blocks/lead color="primary" %}}
Das RipperDoc Reparatur-Wiki sammelt technische Anleitungen und Fehleranalysen aus unserer täglichen Werkstattarbeit in München.

Die Artikel entstehen parallel zu Beiträgen auf [logi.wiki](https://logi.wiki) und [repair.wiki](https://repair.wiki). Pull Requests sind willkommen.
{{% /blocks/lead %}}
...
{{% blocks/feature icon="fab fa-github" title="Mitmachen" url="https://github.com/AlexeyInwerp/wiki.ripperdoc" %}}
...
Zurück zur Reparaturwerkstatt in München.
{{% /blocks/feature %}}
